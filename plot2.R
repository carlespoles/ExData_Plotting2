...
# We create the plot => emissions are going down, but spike in 2005.
plot(dataYears, yearEmissions, pch = 19,  xlab = "Year", ylab = "Total Emissions", main = "Evolution of Total Emissions - Baltimore City", type = "b")

# Saving as PNG. It will be saved in default working directory.
dev.copy(png, "plot2.png", width = 600, height = 480)
dev.off()
